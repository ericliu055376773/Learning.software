                                  ...
                                  {!allTimedPassed && showTimedSection === 'timed' && (
                                    <div className="bg-white p-3 space-y-4">
                                      {!canEdit && !timedSectionStarted && !anyTimedFailed ? (
                                        ...
                                        <>
                                          {!canEdit && timedSectionStarted && !anyTimedFailed && (
                                            <div className="flex items-center justify-between bg-[#EBF2FF]/50 p-2.5 rounded-xl mb-2 sticky top-0 z-10 backdrop-blur-sm">
                                  ...
                                  {!allProctorComputerPassed && showProctorSection && (
                                    <div className="bg-white p-3 space-y-4">
                                      {!canEdit && !proctorSectionStarted ? (
                                        ...
                                        <>
                                          {!canEdit && proctorSectionStarted && (
                                            <div className="flex items-center justify-between bg-[#FCEEEA]/50 p-2.5 rounded-xl mb-2 sticky top-0 z-10 backdrop-blur-sm">
